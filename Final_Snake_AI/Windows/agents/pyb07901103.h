#ifndef __pyb07901103_h__
#define __pyb07901103_h__
...
// you can have argument(s), but all these argument(s) must have their default value
    ...
    Agent_pyb07901103():PolicyMaker("pyb07901103"){}
